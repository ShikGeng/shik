...
public class MybatisGeneratorXml {
    ...
    // 项目名称
    private static String PROJECT_NAME = "shik-common/src/main/java";
    // 数据库名称
    ...
    public static void generator(
        ...
        String module_path = "shik-common/src/main/resources/mybatis-generator/generatorConfig.xml";
...
//			String targetProject = PROJECT_NAME + module_prefix_name.replaceAll("\\.", "-") + "-dao";
            ...
            context.put("project", PROJECT_NAME);
...
//			context.put("targetProject", targetProject);
            ...
            // 删除旧代码
            deleteDir(new File("shik-common/src/main/java/com/shik/dao/model"));
            deleteDir(new File("shik-common/src/main/java/com/shik/dao/mapper"));
        } catch (Exception e) {
            e.printStackTrace();
        }
