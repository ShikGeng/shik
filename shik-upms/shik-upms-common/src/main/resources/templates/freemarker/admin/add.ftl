...
<body class="shik_body">
    <div class="layui-row">
        <div class="layui-col-xs12">
            <form id="shik_admin_form" class="layui-form layui-form-pane" action="/admin/save" method="post">
                ...
                <div class="layui-layer-btn layui-layer-btn-c">
                    ...
                    <a class="layui-layer-btn1 admin_cancel" lay-filter="admin_cancel">取消</a>
                </div>
            </form>
        </div>
    </div>
